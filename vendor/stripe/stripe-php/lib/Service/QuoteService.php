...
class QuoteService extends \Stripe\Service\AbstractService
{
     ...
     * href="https://stripe.com/docs/api/quotes/object#quote_object-computed-upfrontend-line_items"><strong>computed.upfrontend.line_items</strong></a>
     * property containing the first handful of those items. There is also a URL where
     * you can retrieve the full (paginated) list of upfrontend line items.
     *
     * @param string $id
     * @param null|array $params
     * @param null|array|\Stripe\Util\RequestOptions $opts
     ...
     */
    public function allComputedUpfrontendLineItems($id, $params = null, $opts = null)
    {
