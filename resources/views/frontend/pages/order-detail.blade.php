...
@section('title', 'Order Detail || East Horizon')

@push('styles')
  <link rel="stylesheet" href="{{asset('frontend/css/order-detail.css')}}">
@endpush
      ...
      <div class="order-detail-container">
        ...
        <div id="order-action" class="action">
          ...
          @elseif($return && $order->status != 'returned')
            <a href="{{route('cancel-view', ['order_no' => $order->order_no, 'return' => true])}}" class="btn btn-submit action-btn">Return Items</a>
          @endif
        </div>
      </div>
    </section>
