 ...
 <!-- DataTales Example -->
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('city.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add city</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($citys as $city) 
              ...
              <tr>
                ...
                <td>
                  <a href="{{route('city.edit',$city->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
