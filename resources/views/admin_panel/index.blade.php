...
@section('title','East Horizon || DASHBOARD')
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$repaired}}</div>
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Repaired</div>
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$repairedAmount}}</div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                  </div>
