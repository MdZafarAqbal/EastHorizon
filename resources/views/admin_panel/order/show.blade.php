...
<div class="card">
  <h5 class="card-header">Order<a href="{{route('sale.pdf', ['id' => $order->id, 'download' => 1])}}" class=" btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-download fa-sm text-white-50"></i> Invoice </a>
  </h5>
  <div class="card-body">
    @if($order)
