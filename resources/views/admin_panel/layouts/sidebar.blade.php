...
<!--Banner -->
    ...
    <li class="nav-item">
        ...
        <div id="sellerCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('seller.index')}}">Seller Details Product</a>
            <a class="collapse-item" href="{{route('seller.create')}}">Add Seller Details Product</a>
    ...
    <li class="nav-item">
        ...
        <div id="buyingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Product Options:</h6>
            <a class="collapse-item" href="{{route('buying.index')}}">Buy Details Product</a>
            <a class="collapse-item" href="{{route('buying.create')}}">Add Buy Details Product</a>
    ...
    <li class="nav-item">
        ...
        <div id="repairCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Product Options:</h6>
            <a class="collapse-item" href="{{route('repair.index')}}">Repair Products</a>
            <a class="collapse-item" href="{{route('repair.create')}}">Add Repair Product</a>
