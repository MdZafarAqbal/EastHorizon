...
<html lang="en">
<head>
	<title>Help Center || East Horizon</title>
	<style>
		body{
	...
	<div class="layout">
		<div class="accordion">
			<div class="accordion__question">
				<p>Why should I buy from East Horizon.ae?</p>

			</div>
			<div class="accordion__answer">
				<p>We at East Horizon.ae handpicked all the herbs in their natural forms. No artificial chemical or any other substitute is added to any of our product. All the herbs which we collect are sorted, processed and cleaned by the old proven natural traditional methods, which guarantee natural taste and purity. We store all the goods in a hygienic way so that its curing values are not impacted.</p>
		...
		<div class="accordion">
			...
			<div class="accordion__answer">
				<p><i>
					a)	You will receive a tracking number by email once the order is dispatched. You may track your order on www.East Horizon.ae<br>
...
<?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/frontend/pages/faq.blade.php ENDPATH**/ ?>