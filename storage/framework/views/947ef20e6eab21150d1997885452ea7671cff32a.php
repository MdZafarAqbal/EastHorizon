  ...
  <div class="card-body">
    <form action="<?php echo e(route('review.update',$review->id)); ?>" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" disabled class="form-control" value="<?php echo e($review->user->fname); ?>">
      </div>
      <div class="form-group">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\review\edit.blade.php ENDPATH**/ ?>