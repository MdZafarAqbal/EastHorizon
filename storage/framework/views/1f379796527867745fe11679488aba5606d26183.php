...
<div class="bg-light p-4 rounded">
        ...
        <div class="container mt-4">
            <form method="post" action="<?php echo e(route('seller.update', $seller->id)); ?>">
                <?php echo method_field('patch'); ?>
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label for="seller_name" class="form-label">Seller Name</label>
                    <input value="<?php echo e($seller->seller_name); ?>" 
                        type="text" 
                        class="form-control" 
                        name="seller_name" 
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->mobile_no); ?>"
                        type="mobile_no" 
                        class="form-control" 
                        name="mobile_no" 
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->product_name); ?>"
                        type="text" 
                        class="form-control" 
                        name="product_name" 
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->serial_no); ?>"
                        type="text" 
                        class="form-control" 
                        name="serial_no" 
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->imei_no); ?>"
                        type="text" 
                        class="form-control" 
                        name="imei_no" 
                        placeholder="IMEI No" >
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->qty); ?>"
                        type="text" 
                        class="form-control" 
                        name="qty" 
                ...
                <div class="mb-3">
                    ...
                    <input value="<?php echo e($seller->price); ?>"
                        type="text" 
                        class="form-control" 
                        name="price" 
                ...
                <a href="<?php echo e(route('seller.index')); ?>" class="btn btn-default">Cancel</button>
            </form>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/admin_panel/seller/edit.blade.php ENDPATH**/ ?>