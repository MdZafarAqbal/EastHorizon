          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              ...
              <?php
                ...
                $repaired = DB::table('repairs')->count();
                $repairedAmount = DB::table('repairs')->sum('charge');
              ?>
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-info shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Repairs Product</div>
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($repaired); ?></div>
                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Repaired</div>
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($repairedAmount); ?></div>
                <div class="row no-gutters align-items-center">
                  <div class="col-auto">
                  </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/admin_panel/index.blade.php ENDPATH**/ ?>