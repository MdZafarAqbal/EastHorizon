  ...
  <nav class="nav" id="mob-nav">
    ...
    <div class="navbar-content">
      <ul class="menu">
        ...
        <li><a href="<?php echo e(route('repair-create')); ?>" class="nav-link mob-nav">Repair</a></li>
  ...
  <div class="topbar" id="desktop-header">
    ...
    <nav class="menu-bar" id="desktop-menu">
      <ul class="menu">
        ...
        <li><a href="<?php echo e(route('repair-create')); ?>" class="nav-link desktop-nav">Repair</a></li>
...
<?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>