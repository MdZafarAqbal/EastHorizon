...
<html lang="en">
<head>
	<title>Privacy Policy || East Horizon</title>
	<style>
		body{
	...
	<div class="layout">
		<div class="accordion">
			<div class="accordion__question">
				<ol>
					<li>This privacy policy applies to East Horizon website at www.East Horizon.ae. We at East Horizon take your privacy seriously. This policy covers the collection, processing and other use of personal data under the Personal Data Protection Law, Federal Decree Law No. 45 of 2021 constitutes an integrated framework to ensure the confidentiality of information and protect the privacy of individuals in the UAE.</li><br>
...
<?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/frontend/pages/privacy-policy.blade.php ENDPATH**/ ?>