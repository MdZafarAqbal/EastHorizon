...
<!--Banner -->
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#sellerCollapse" aria-expanded="true" aria-controls="sellerCollapse">
          <i class="fas fa-cubes"></i>
          <span>Seller Details</span>
        </a>
        <div id="sellerCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Product Options:</h6>
            <a class="collapse-item" href="<?php echo e(route('seller.index')); ?>">Seller Details Product</a>
            <a class="collapse-item" href="<?php echo e(route('seller.create')); ?>">Add Seller Details Product</a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#buyingCollapse" aria-expanded="true" aria-controls="buyingCollapse">
          <i class="fas fa-cubes"></i>
          <span>Buy Details</span>
        </a>
        <div id="buyingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Product Options:</h6>
            <a class="collapse-item" href="<?php echo e(route('buying.index')); ?>">Buy Details Product</a>
            <a class="collapse-item" href="<?php echo e(route('buying.create')); ?>">Add Buy Details Product</a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#repairCollapse" aria-expanded="true" aria-controls="repairCollapse">
          <i class="fas fa-cubes"></i>
          <span>Repair</span>
        </a>
        <div id="repairCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Product Options:</h6>
            <a class="collapse-item" href="<?php echo e(route('repair.index')); ?>">Repair Products</a>
            <a class="collapse-item" href="<?php echo e(route('repair.create')); ?>">Add Repair Product</a>
...
</ul><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/admin_panel/layouts/sidebar.blade.php ENDPATH**/ ?>