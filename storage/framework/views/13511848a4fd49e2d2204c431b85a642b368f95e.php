        ...
        <table class="table table-bordered" id="attribute-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <?php $__currentLoopData = $product['attrs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <form method="post" id="edit<?php echo e($attribute->id); ?>" action="<?php echo e(route('editAttribute', ['id' => $product->id])); ?>" enctype="multipart/form-data"> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views/admin_panel/product/edit.blade.php ENDPATH**/ ?>