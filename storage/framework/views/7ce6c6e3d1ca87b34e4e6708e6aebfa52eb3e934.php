            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        ...
                        <?php else: ?> 
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="<?php echo e(asset('admin_panel/img/avatar.png')); ?>" alt="profile picture">
                        <?php endif; ?>
                    </div>
                    <div class="card-body mt-4 ml-2">
                      <h5 class="card-title text-left"><small><i class="fas fa-user"></i> <?php echo e($profile->fname); ?>&nbsp;<?php echo e($profile->lname); ?></small></h5>
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="<?php echo e(route('user-profile-update',$profile->id)); ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="<?php echo e($profile->fname); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="name" placeholder="Enter name"  value="<?php echo e($profile->lname); ?>" class="form-control">
                        <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<style>
    ...
    .image{
        background:url('<?php echo e(asset('admin_panel/img/background.jpg')); ?>');
        height:150px;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\user\users\profile.blade.php ENDPATH**/ ?>