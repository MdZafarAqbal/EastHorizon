<div id="notifications">
    ...
    <a class="dropdown-item d-flex align-items-center" target="_blank" href="<?php echo e(route('admin.notification',$notification->id)); ?>">
                ...
                <div>
                    ...
                    <span class="<?php if($notification->unread()): ?> font-weight-bold <?php else: ?> small text-gray-500 <?php endif; ?>"><?php echo e($notification->data['name']); ?></span>
                </div>
            </a>
...
</div><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views/admin_panel/notification/show.blade.php ENDPATH**/ ?>