...
<div class="bg-light p-4 rounded">
        ...
        <div class="container mt-4">
            <form method="POST" action="<?php echo e(route('buying.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label for="buying_name" class="form-label">Name</label>
                    <input value="<?php echo e(old('buying_name')); ?>" 
                        type="text" 
                        class="form-control" 
                        name="buying_name" 
                        placeholder="Name" required>

                    <?php if($errors->has('buying_name')): ?>
                        <span class="text-danger text-left"><?php echo e($errors->first('buying_name')); ?></span>
                    <?php endif; ?>
                </div>
                <div class="mb-3">
                ...
                <a href="<?php echo e(route('buying.index')); ?>" class="btn btn-default">Back</a>
            </form>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/admin_panel/buying/create.blade.php ENDPATH**/ ?>