...
<?php $dep = $depth-1; ?>
<div class="display-comment"   <?php if($comment->parent_cat != null): ?> style="margin-left:40px;" <?php endif; ?>>
    <div class="comment-list">
        <div class="single-comment">
            <?php if($comment->user_info['photo']): ?>
                <img src="<?php echo e($comment->user_info['photo']); ?>" alt="#">
            <?php else: ?> 
                <img src="<?php echo e(asset('admin_panel/img/avatar.png')); ?>" alt="">
            <?php endif; ?>
            <div class="content">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\frontend\pages\comment.blade.php ENDPATH**/ ?>