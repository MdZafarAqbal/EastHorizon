...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('banner.update',$banner->id)); ?>">
        ...
        <input id="inputName" type="text" name="name" placeholder="Enter name"  value="<?php echo e($banner->name); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail" class="form-control" type="text" name="photo_desktop" value="<?php echo e($banner->photo_desktop); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail1" class="form-control" type="text" name="photo_tablet" value="<?php echo e($banner->photo_tablet); ?>">
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="thumbnail2" class="form-control" type="text" name="photo_mobile" value="<?php echo e($banner->photo_mobile); ?>">
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\banner\edit.blade.php ENDPATH**/ ?>