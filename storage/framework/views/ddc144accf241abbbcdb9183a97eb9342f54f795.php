...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" style="background-color:rgb(67, 83, 255)" id="nav">
            ...
            <div class="form-group" id="attachment">
              <div class="controls text-center">
                <div class="input-group w-100">
                  <a class="btn btn-primary w-100 text-white" style="background-color:rgb(67, 83, 255)" id="upload-button"><?php echo e(trans('laravel-filemanager::lfm.message-choose')); ?></a>
                </div>
              </div>
            </div>
...
<?php /**PATH D:\XAMPP\htdocs\East Horizon\vendor\unisharp\laravel-filemanager\src\views\index.blade.php ENDPATH**/ ?>