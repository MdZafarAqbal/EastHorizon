        ...
        <div class="row ">
            <div class="card-header py-3">
                <div class="card">
                    ...
                    <form action="<?php echo e(route('productImport.store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\product\index.blade.php ENDPATH**/ ?>