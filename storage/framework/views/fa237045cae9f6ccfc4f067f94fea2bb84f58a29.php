 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                <tr>
                    ...
                    <td>
                        <?php if($banner->photo_desktop): ?>
                            <img src="<?php echo e($banner->photo_desktop); ?> " class="img-fluid zoom" style="max-width:80px" alt="<?php echo e($banner->photo); ?>">
                            <img src="<?php echo e($banner->photo_tablet); ?> " class="img-fluid zoom" style="max-width:80px" alt="<?php echo e($banner->photo); ?>">
                            <img src="<?php echo e($banner->photo_mobile); ?> " class="img-fluid zoom" style="max-width:80px" alt="<?php echo e($banner->photo); ?>">
                        <?php else: ?>
        ...
        <?php echo $banners->withQueryString()->links('pagination::bootstrap-5'); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\banner\index.blade.php ENDPATH**/ ?>