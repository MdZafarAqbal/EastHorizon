...
<?php $__env->startSection('title','East Horizon || Brand Edit'); ?>
...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('brand.update',$brand->id)); ?>">
        ...
        <input id="inputName" type="text" name="name" placeholder="Enter title"  value="<?php echo e($brand->name); ?>" class="form-control">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\brand\edit.blade.php ENDPATH**/ ?>