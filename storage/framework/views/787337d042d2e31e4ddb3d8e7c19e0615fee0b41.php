...
<?php $__env->startPush('styles'); ?>
  <link href="<?php echo e(asset('frontend/css/checkout.css')); ?>" rel="stylesheet">
<?php $__env->stopPush(); ?>
...
<section class="shop-checkout checkout-sec">
  ...
  <div class="form-container">
    ...
    <form class="form" id="order-form" method="POST" action="<?php echo e(route('order')); ?>" novalidate>
      <?php echo csrf_field(); ?>
      ...
      <fieldset class="details">
        ...
        <div class="fl-bl">
          <div class="form-group" id="first-name">
            ...
            <input type="text" id="fname" name="fname" placeholder="First Name" value="<?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->fname); ?><?php endif; ?>">
          </div>

          <div class="form-group collapse" id="company-name">
            <label for="cname">Company Name<span>*</span></label>
            <input type="text" id="cname" name="cname" placeholder="Company Name" value="<?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->cname); ?><?php endif; ?>">
          </div>

          <div class="form-group" id="last-name">
            <label for="lname">Last Name<span>*</span></label>
            <input type="text" id="lname" name="lname" placeholder="Last Name" value="<?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->lname); ?><?php endif; ?>">
          </div>

          <div class="form-group collapse" id="trn">
            <label for="trn-number">TRN<span>*</span></label>
            <input type="number" id="trn-number" name="trn_no" placeholder="TRN Number" value="<?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->trn_no); ?><?php endif; ?>">
          </div>
        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="email" name="email" id="email" placeholder="Email Address" value="<?php if(auth()->guard()->check()): ?><?php echo e(auth()->user()->email); ?><?php endif; ?>">
        </div>
        ...
        <div id="shipping-details" class="collapse">
          <div class="fl-bl">
            <div class="form-group" id="shipping-first-name">
              ...
              <input type="text" id="shipping-fname" name="shipping_fname" placeholder="First Name" value="<?php echo e(old('shipping-fname')); ?>">
            </div>

            <div class="form-group" id="shipping-last-name">
              <label for="shipping-lname">Last Name<span>*</span></label>
              <input type="text" id="shipping-lname" name="shipping_lname" placeholder="Last Name" value="<?php echo e(old('shipping-lname')); ?>">
            </div>
          </div>

          <?php if($errors->get('shipping-fname')): ?>
            <div class="error">
              <?php $__errorArgs = ['shipping-fname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <?php if($errors->get('shipping-lname')): ?>
            <div class="error">
              <?php $__errorArgs = ['shipping-lname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="form-group">
            ...
            <input type="text" name="shipping_address" id="shipping-address" placeholder="Shipping Address" value="<?php echo e(old('shipping-address')); ?>">
          </div>

          <?php if($errors->get('shipping-address')): ?>
            <div class="error">
              <?php $__errorArgs = ['shipping-address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="fl-bl">
            <div class="form-group">
              ...
              <input type="text" name="shipping_landmark" id="shipping-landmark" placeholder="Nearby Landmark" value="<?php echo e(old('shipping-landmark')); ?>">
            </div>
      ...
      <fieldset class="op-form collapse" id="op-form">
        ...
        <div class="fl-bl">
          <div class='form-group expiry'>
            ...
            <input type="number" class='expiry-month' id='expiry-month' name="expiry_month" min= "<?php echo date('m'); ?>" placeholder='MM' value="<?php echo e(old('expiry_month')); ?>">
          </div>
          
          <div class='form-group expiry'>
            <label for="expiry-year">Expiry Year</label>
            <input type="number" class='expiry-year' id='expiry-year' name="expiry_year" min= "<?php echo date('Y'); ?>" placeholder='YYYY' value="<?php echo e(old('expiry_year')); ?>">
          </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\frontend\pages\checkout.blade.php ENDPATH**/ ?>