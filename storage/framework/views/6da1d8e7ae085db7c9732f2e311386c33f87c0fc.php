...
<?php $component->withAttributes([]); ?>
  ...
  Welcome to **East Horizon**, the ultimate destination for all-natural goodness!

  We're so glad you've decided to join our community of herb lovers and natural beauty enthusiasts. As a registered member, you'll now get exclusive access to all kinds of special offers and early access to new products, and insider info on all our latest natural products.

  As a member of East Horizon, you're  joining a community of people who believe in the power of natural goodness. We're here to help you on your journey to a healthier, more natural lifestyle, and we can't wait to see what you accomplish.

  So go ahead and explore all that East Horizon has to offer.

  <?php if($password): ?> 
    Your email address and password is
...
<?php endif; ?>
  ...
  Thanks again for joining us on this journey. We're thrilled to have you as part of the **East Horizon** family!
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views/emails/email-verification.blade.php ENDPATH**/ ?>