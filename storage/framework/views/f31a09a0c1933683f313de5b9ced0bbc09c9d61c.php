...
<head>
  <title>East Horizon || Login Page</title>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="text-center">
                    <?php if(Route::has('password.reset')): ?>
                        <a class="btn btn-link small" href="<?php echo e(route('password.reset')); ?>">
...
<?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\auth\login.blade.php ENDPATH**/ ?>