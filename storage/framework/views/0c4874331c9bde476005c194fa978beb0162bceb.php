            ...
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>             
              <tr>
                ...
                <td>
                  ...
                  <?php elseif($order->status=='processsed'): ?>
                ...
                <td>
                  <?php if($order->shipping->status=='ordered'): ?>
                    <span class="badge badge-primary"><?php echo e($order->shipping->status); ?></span>
                  <?php elseif($order->shipping->status=='processed'): ?>
                    <span class="badge badge-secondary"><?php echo e($order->shipping->status); ?></span>
                  <?php elseif($order->shipping->status=='shipped'): ?>
                    <span class="badge badge-info"><?php echo e($order->shipping->status); ?></span>
                  <?php else: ?>
                    <span class="badge badge-success"><?php echo e($order->shipping->status); ?></span>
                  <?php endif; ?>
                </td>         
                <td>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/admin_panel/order/index.blade.php ENDPATH**/ ?>