...
<?php $__env->startSection('main-content'); ?>
    ...
    <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="about-img">
        <img class="about-img-img" src="<?php echo e($data->photo); ?>" alt="About Us image">
      </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\East-Horizon\resources\views/frontend/pages/about-us.blade.php ENDPATH**/ ?>