<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!-- Nav Item - Alerts -->
      <li class="nav-item dropdown no-arrow mx-1">
       <?php echo $__env->make('admin_panel.notification.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </li>
...
<?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views/admin_panel/layouts/header.blade.php ENDPATH**/ ?>