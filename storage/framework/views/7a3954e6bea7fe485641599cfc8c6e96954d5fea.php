          ...
          <tbody>
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <?php if(!empty($city)): ?>
                      <td> : AED <?php echo e($order->city->price); ?></td>
                    <?php endif; ?>
                    <td>AED <?php echo e(number_format($order->total_amount,2)); ?></td>
                    <td>
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\user\order\index.blade.php ENDPATH**/ ?>