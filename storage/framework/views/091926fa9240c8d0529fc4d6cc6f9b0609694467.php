...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="sci_name" placeholder="Enter Scientific Name"  value="<?php echo e(old('sci_name')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="other_name" name="other_name"><?php echo e(old('other_name')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="benefits" name="benefits"><?php echo e(old('benefits')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="precautions" name="precautions"><?php echo e(old('precautions')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input id="minprice" type="number" name="minprice" value="<?php echo e(old('minprice')); ?>" class="form-control">
...
<?php echo $__env->make('admin_panel.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\East Horizon\resources\views\admin_panel\product\create.blade.php ENDPATH**/ ?>